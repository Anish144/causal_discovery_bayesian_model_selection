...
def cholesky(matrix, max_attempts: int = 5, jitter: float = 1e-8):
    ...
    def body(state):
        ...
        tf.print("OK = ", ok, "is_not_nan = ", tf.reduce_all(tf.math.is_finite(res)), "jitter = ", jitter)
