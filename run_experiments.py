...
from experiments.linear_gaussian_sample_size import linear_gaussian_sample_size_exp
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--num_inducing', '-ni', type=int, default=200,
    ...
    parser.add_argument(
        '--num_minibatch', '-mini_size', type=int, default=500,
        help="Size of a minibatch."
    )
    parser.add_argument(
        '--adam_lr', '-lr', type=float, default=0.01,
